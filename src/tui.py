...
def show_menu() -> None:
    ...
    console.print("│ [green][1][/green] Build Release              │")
    console.print("│ [2] Build Kernel Only             │")
    console.print("│ [3] Build Bootloader Only         │")
    console.print("│ [4] Build Services Only           │")
    console.print("[yellow]└─────────────────────────────────────┘[/yellow]")
    
    console.print()
    console.print("[yellow]┌─ Run ───────────────────────────────┐[/yellow]")
    console.print("│ [green][5][/green] Run QEMU (com monitoramento) │")
    console.print("│ [6] Run QEMU + GDB              │")
    console.print("[yellow]└─────────────────────────────────────┘[/yellow]")
    
    console.print()
    console.print("[yellow]┌─ Analysis ─────────────────────────┐[/yellow]")
    console.print("│ [7] Analyze Last Log              │")
    console.print("│ [8] Inspect Kernel (SSE check)    │")
    console.print("│ [9] Code Statistics               │")
    console.print("[yellow]└─────────────────────────────────────┘[/yellow]")
    
    console.print()
    console.print("[yellow]┌─ Utilities ───────────────────────┐[/yellow]")
    console.print("│ [C] Clean                         │")
    console.print("│ [E] Environment                   │")
